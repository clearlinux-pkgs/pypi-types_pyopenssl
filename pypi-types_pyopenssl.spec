...
Source0  : https://files.pythonhosted.org/packages/9d/f2/1057c930f1eec1d761ced3d7dd531974cd6f3259a2b987335f8f0ee0ecd9/types-pyOpenSSL-22.0.4.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.0.4
cd %{_builddir}/types-pyOpenSSL-22.0.4
pushd ..
cp -a types-pyOpenSSL-22.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656344164
