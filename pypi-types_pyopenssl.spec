...
Source0  : https://files.pythonhosted.org/packages/69/17/f6dc5a3fd892e7904f1643363a5f2327bead267a66a50c287c1fe6dc63ae/types-pyOpenSSL-23.0.0.2.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-23.0.0.2
cd %{_builddir}/types-pyOpenSSL-23.0.0.2
pushd ..
cp -a types-pyOpenSSL-23.0.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674150228
