...
Source0  : https://files.pythonhosted.org/packages/a4/43/32f874b5fa2240932d758c8f4350632e4edd19e662032ff4992ebcd8a882/types-pyOpenSSL-23.3.0.0.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-23.3.0.0
cd %{_builddir}/types-pyOpenSSL-23.3.0.0
pushd ..
cp -a types-pyOpenSSL-23.3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698684004
