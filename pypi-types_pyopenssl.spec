...
Source0  : https://files.pythonhosted.org/packages/e8/8b/4ddeebfdc5f900a94924061c4f3144aa6079d70378425978bf746febff68/types-pyOpenSSL-23.0.0.4.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-23.0.0.4
cd %{_builddir}/types-pyOpenSSL-23.0.0.4
pushd ..
cp -a types-pyOpenSSL-23.0.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676998141
