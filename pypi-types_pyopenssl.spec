...
Source0  : https://files.pythonhosted.org/packages/af/f6/8b0f178a8d40d1d09d6dec97ec59a032c99612847a0ab0aaca829970df14/types-pyOpenSSL-22.1.0.2.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.1.0.2
cd %{_builddir}/types-pyOpenSSL-22.1.0.2
pushd ..
cp -a types-pyOpenSSL-22.1.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667845836
