...
Source0  : https://files.pythonhosted.org/packages/01/d3/8e3f365204734e4772cc264f6c933ef6a261450bf1ea5172d5bbec8e634f/types-pyOpenSSL-24.0.0.20240228.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-24.0.0.20240228
cd %{_builddir}/types-pyOpenSSL-24.0.0.20240228
pushd ..
cp -a types-pyOpenSSL-24.0.0.20240228 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709136443
