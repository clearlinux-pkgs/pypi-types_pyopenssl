...
Source0  : https://files.pythonhosted.org/packages/c7/97/306614ed88b1d2f77e40f80e7a18ecb925e2920e95a6d9570dc6c5ba3769/types-pyOpenSSL-23.0.0.1.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-23.0.0.1
cd %{_builddir}/types-pyOpenSSL-23.0.0.1
pushd ..
cp -a types-pyOpenSSL-23.0.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673454881
