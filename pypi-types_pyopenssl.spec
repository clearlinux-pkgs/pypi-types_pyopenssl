...
Source0  : https://files.pythonhosted.org/packages/47/b4/a901e347265014d707230db2eb4f60749e16f34657b56a1ba688d39cca45/types-pyOpenSSL-22.1.0.1.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.1.0.1
cd %{_builddir}/types-pyOpenSSL-22.1.0.1
pushd ..
cp -a types-pyOpenSSL-22.1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666020752
