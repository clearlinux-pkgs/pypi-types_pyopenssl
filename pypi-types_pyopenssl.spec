...
Source0  : https://files.pythonhosted.org/packages/01/f8/f7af5a65f4cd501dc6319204ce11cfce973d26016bea5b8418a8de9e73e6/types-pyOpenSSL-21.0.1.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-21.0.1
cd %{_builddir}/types-pyOpenSSL-21.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639059171
