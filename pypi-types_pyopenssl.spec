...
Source0  : https://files.pythonhosted.org/packages/dd/0f/48f415fbb620610d03abfec01172b44094eb04c234273846060134f107a0/types-pyOpenSSL-24.0.0.20240130.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-24.0.0.20240130
cd %{_builddir}/types-pyOpenSSL-24.0.0.20240130
pushd ..
cp -a types-pyOpenSSL-24.0.0.20240130 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706633166
