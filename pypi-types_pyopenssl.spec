...
Source0  : https://files.pythonhosted.org/packages/a5/e3/b47c766809d75917be6d52c7c0639255232e6b1c004c7b4ffce04ab31a0f/types-pyOpenSSL-22.0.5.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.0.5
cd %{_builddir}/types-pyOpenSSL-22.0.5
pushd ..
cp -a types-pyOpenSSL-22.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658500126
