...
Source0  : https://files.pythonhosted.org/packages/c7/e2/86516e0124f7552c001e04651df9956edfa7aadd3fbf7b83ba9dfe17cf93/types-pyOpenSSL-21.0.3.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-21.0.3
cd %{_builddir}/types-pyOpenSSL-21.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641944277
