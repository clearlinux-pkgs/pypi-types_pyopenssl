...
Source0  : https://files.pythonhosted.org/packages/5e/e8/e06947a39bc223a477291da4bd2742779aecf93452621e4952bb089d0ad9/types-pyOpenSSL-22.0.10.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.0.10
cd %{_builddir}/types-pyOpenSSL-22.0.10
pushd ..
cp -a types-pyOpenSSL-22.0.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659108274
