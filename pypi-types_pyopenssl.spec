...
Source0  : https://files.pythonhosted.org/packages/c3/c0/83e2d59e4ce78b3bfc507c5c85e25ec245071d921c8ba0cd2138dc57fbe6/types-pyOpenSSL-22.0.3.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.0.3
cd %{_builddir}/types-pyOpenSSL-22.0.3
pushd ..
cp -a types-pyOpenSSL-22.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653009315
