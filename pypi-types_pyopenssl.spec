...
Source0  : https://files.pythonhosted.org/packages/0b/27/4112745fb4f44d89c3260fc683fae69b2bb2c724e1e1994c3e24f21d24e8/types-pyOpenSSL-24.0.0.20240311.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-24.0.0.20240311
cd %{_builddir}/types-pyOpenSSL-24.0.0.20240311
pushd ..
cp -a types-pyOpenSSL-24.0.0.20240311 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710174125
