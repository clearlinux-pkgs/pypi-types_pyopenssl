...
Source0  : https://files.pythonhosted.org/packages/da/88/32a746684bee8ca4cbaf919ac184d9e9e75e66cca36bee009495a53f19c5/types-pyOpenSSL-23.0.0.3.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-23.0.0.3
cd %{_builddir}/types-pyOpenSSL-23.0.0.3
pushd ..
cp -a types-pyOpenSSL-23.0.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676393156
