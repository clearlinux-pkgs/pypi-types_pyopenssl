...
Source0  : https://files.pythonhosted.org/packages/69/ec/378e4368ecabef95cc136d86d95ecf5098592fdfaa044774e20de90396d9/types-pyOpenSSL-23.3.0.20240106.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-23.3.0.20240106
cd %{_builddir}/types-pyOpenSSL-23.3.0.20240106
pushd ..
cp -a types-pyOpenSSL-23.3.0.20240106 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704729803
