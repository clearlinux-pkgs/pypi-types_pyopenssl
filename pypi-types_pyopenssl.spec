...
Source0  : https://files.pythonhosted.org/packages/93/29/47a346550fd2020dac9a7a6d033ea03fccb92fa47c726056618cc889745e/types-pyOpenSSL-24.1.0.20240722.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-24.1.0.20240722
cd %{_builddir}/types-pyOpenSSL-24.1.0.20240722
pushd ..
cp -a types-pyOpenSSL-24.1.0.20240722 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730264723
