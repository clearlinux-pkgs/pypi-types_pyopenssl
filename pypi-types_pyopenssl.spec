...
Source0  : https://files.pythonhosted.org/packages/b1/cd/9fe0c9d7c24fc19e6d58b5c31d10dbdb5dde8386e117741ed1dc3fef8bf3/types-pyOpenSSL-22.0.8.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.0.8
cd %{_builddir}/types-pyOpenSSL-22.0.8
pushd ..
cp -a types-pyOpenSSL-22.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658765154
