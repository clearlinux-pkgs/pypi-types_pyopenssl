...
Source0  : https://files.pythonhosted.org/packages/af/a9/eb1b06892eadd41712ffcf77e8a0b2a84c922e13155be2469a4690ead5f7/types-pyOpenSSL-22.1.0.0.tar.gz
...
%prep
%setup -q -n types-pyOpenSSL-22.1.0.0
cd %{_builddir}/types-pyOpenSSL-22.1.0.0
pushd ..
cp -a types-pyOpenSSL-22.1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664983364
